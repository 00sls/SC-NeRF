...
for ckpt in list_ckpt:
    ...
    for i_scene, scene in enumerate(['fern' , 'flower' , 'fortress' , 'horns' , 'leaves' , 'orchids' , 'room' , 'trex']):#
        ...
        --dataset_name llff \
        --net_type v0 --ckpt ./best_step/{ckpt}'
        ...
        save_dir = f'results/render_llff_{ckpt_split}'
        ...
        with torch.no_grad():
            ...
            for i, batch in enumerate(tqdm(dataset)):
                ...
                volume_feature, img_feat, _ = MVSNet(imges_source, proj_mats, near_far_source, pad=pad, lindisp=False)
                ...
                for chunk_idx in range(N_rays_all//args.chunk + int(N_rays_all%args.chunk>0)):
                    ...
                    # rendering
                    rgb, disp, acc, depth_map_fn, depth_pred, alpha, extras = rendering(args,feat_sampled,ndc_3d, pose_source, xyz_coarse_sampled,xyz_NDC, z_vals, rays_o, rays_d,
